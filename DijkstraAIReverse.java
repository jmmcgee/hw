...
public class DijkstraAIReverse implements AIModule
{
    ...
    public List<Point> createPath(final TerrainMap map)
    {
        ...
        end = new HeuristicPoint(null, map.getStartPoint(), 0.0, 0.0);
        start = new HeuristicPoint(null, map.getEndPoint(), 0.0, 0.0);
        open.add(start);
        ...
        while(!open.isEmpty())
        {
            ...
            for(Point p : map.getNeighbors(currentPoint)) {
            	double knownCost = currentPoint.knownCost + map.getCost(p, currentPoint);
